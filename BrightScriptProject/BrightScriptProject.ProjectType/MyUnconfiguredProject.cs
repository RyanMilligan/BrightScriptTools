...
namespace BrightScript
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Bright Script", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "bsproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "BrightScriptProject";

        internal const string Language = "BrightScriptProject";
